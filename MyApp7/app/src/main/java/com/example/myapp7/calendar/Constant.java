package com.example.myapp7.calendar;
...
public class Constant {
    ...
    public final static Integer[] festivalResArray = {
            ...
            R.drawable.festival_women, R.drawable.festival_qingming, R.drawable.festival_laodong,
            R.drawable.festival_mother, R.drawable.festival_children, R.drawable.festival_duanwu,
            R.drawable.festival_jiandang, R.drawable.festival_qixi, R.drawable.festival_zhongqiu,
